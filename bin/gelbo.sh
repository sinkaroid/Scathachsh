...
begin=$(date +"%s")
echo "${GREEN}[gelbooru stealer] / [-sin]"
echo '
...
mkdir -pv "./res/gelboo~${var}" 
#do

cd "./res/gelboo~${var}";

#cf issues
wget --page-requisites --span-hosts -O ${kode}.html "https://gelbooru.com/index.php?page=dapi&s=post&q=index&limit=${count}&tags=${kode}"; 
