...
mkdir -pv "./res/rule~${var}" 
#do

cd "./res/rule~${var}";

#cf issues
wget --page-requisites --span-hosts -O ${kode}.html "https://rule34.xxx/index.php?page=dapi&s=post&q=index&limit=${count}&tags=${kode}"; 
