...
mkdir -pv "./res/tbib~${var}" 
#do

cd "./res/tbib~${var}";

#cf issues
wget --page-requisites --span-hosts -O ${kode}.html "https://tbib.org/index.php?page=dapi&s=post&q=index&limit=${count}&tags=${kode}"; 
